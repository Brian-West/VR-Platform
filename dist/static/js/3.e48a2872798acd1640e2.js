...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_LoginWallpaper_jpg__ = __webpack_require__(500);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_news_png__ = __webpack_require__(498);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_product_png__ = __webpack_require__(499);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_chat_png__ = __webpack_require__(501);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_wiki_png__ = __webpack_require__(503);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_comment_png__ = __webpack_require__(502);
					...
					this.$axios({
						...
						if (response.data.code === 200) {
							...
							if (response.data.type === 0) {
								...
								localStorage.setItem('ms_username', response.data.nickname);
								sessionStorage.setItem('ms_type', response.data.type);
								self.$router.push('/admin/news-management/list');
							}
						} else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("登录")])], 1), _vm._v(" "), _c('div', [_c('br'), _vm._v(" "), _c('p', {
    attrs: {
      "id": "toRegister"
    }
  }, [_vm._v("Tips : 没有账号？"), _c('span', {
    attrs: {
      "id": "register"
    },
    on: {
  ...
  }, [_vm._v("请注册 ")])])])], 1)], 1), _vm._v(" "), _c('el-tab-pane', {
    attrs: {
      "label": "注册",
      "name": "register"
    }
  ...
  }, [_vm._v("注册")])], 1), _vm._v(" "), _c('div', [_c('br'), _vm._v(" "), _c('p', {
    attrs: {
      "id": "toLogin"
    }
  }, [_vm._v("Tips : 已有账号？"), _c('span', {
    attrs: {
      "id": "login"
    },
    on: {
  ...
  }, [_vm._v("去登录 ")])])])], 1)], 1)], 1)], 1)]), _vm._v(" "), _c('h1', {
  ...
  }, [_vm._v("虚拟现实产品质量评估平台")]), _vm._v(" "), _c('span', {
    staticClass: "ms-intro"
  }, [_vm._v("带你全方位了解VR世界")])])
...
var update = __webpack_require__(186)("04933c6a", content, true);
