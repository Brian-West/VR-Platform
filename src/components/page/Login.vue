				...
				<el-tabs v-model="activePane">
						...
						<el-form :model="login" :rules="loginRules" ref="login" label-width="0px">
							...
							<el-form :model="login" :rules="loginRules" ref="login" label-width="0px">
								<el-form-item prop="verCode">
									...
									<el-input v-popover:a placeholder="验证码" v-model="login.verCode" @keyup.enter.native="loginForm('login')">
									</el-input>
								</el-form-item>
							</el-form>
							<div class="login-btn">
					...
					<el-tab-pane label="注册" name="register">
						<el-form :model="register" :rules="registerRules" ref="register" label-width="0px">
							...
							<el-form :model="register" :rules="registerRules" ref="register" label-width="0px">
								<el-form-item prop="verCode">
									<el-popover ref="b" placement="right-end" trigger="hover">
										<img :src="imgUrl" alt="验证码图片" width="200px" @click="getVerCode">
									</el-popover>
									<el-input v-popover:b placeholder="验证码" v-model="register.verCode" @keyup.enter.native="registerForm('register')">
									</el-input>
								</el-form-item>
							</el-form>
							<div class="login-btn">
